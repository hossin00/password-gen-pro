...
const SLIDES=[{"accent": "#8b5cf6", "icon": "\ud83d\udd11", "title": "Generate unbreakable\npasswords instantly", "desc": "Set length and complexity rules. Get a strong password in milliseconds."}, {"accent": "#7c3aed", "icon": "\ud83d\udccb", "title": "Copy with\none tap", "desc": "Generated passwords copy to clipboard instantly."}, {"accent": "#5b21b6", "icon": "\ud83d\udd12", "title": "Zero cloud,\ntotal privacy", "desc": "Passwords are never stored, never uploaded. Generated locally."}];
